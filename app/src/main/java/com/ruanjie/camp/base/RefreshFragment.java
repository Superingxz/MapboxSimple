 ...
 * 当然也可以自己调整
 */
public abstract class RefreshFragment<P extends IBasePresenter> extends ToolbarFragment<P> implements
    ...
    protected void addItemDecoration(@ColorRes int id,int mDividerHeight) {
        //设置默认分割线
        if (mRecyclerView != null) {
            mRecyclerView.addItemDecoration(new ColorDividerDecoration(ContextCompat.getColor(mContext, id),mDividerHeight));
        }
    }
