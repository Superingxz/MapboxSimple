...
public abstract class RefreshActivity<P extends IBasePresenter> extends ToolbarActivity<P> implements
    ...
    /*** 每页请求max数量 */
    public static int PAGE_COUNT_MAX = 10000000;
    /*** 页码，默认从1开始 */
    ...
    protected void addItemDecoration(@ColorRes int id) {
        if (mRecyclerView != null) {
            mRecyclerView.addItemDecoration(new ColorDividerDecoration(ContextCompat.getColor(this, id)));
        }
    }
    ...
    protected void addItemDecoration(@ColorRes int id,int mDividerHeight) {
        //设置默认分割线
        if (mRecyclerView != null) {
            mRecyclerView.addItemDecoration(new ColorDividerDecoration(ContextCompat.getColor(this, id),mDividerHeight));
        }
    }
