...
import com.ruanjie.camp.Constants;
...
//            data.put("orgin", "0");
            ...
            if (!TextUtils.isEmpty(userId)) {
                ...
                data.put("origin", "0");
                data.put("ln", BaseSPManager.getLanguage().getLanguage());
                data.put("mx", SP.getLocationLongtude());
                data.put("my", SP.getLocationLatitude());
            }
        ...
        String value = replaceBlank2(data.toString());
